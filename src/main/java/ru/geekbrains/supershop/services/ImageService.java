...
public class ImageService {
    ...
    public BufferedImage loadFileAsResourceById(String id) throws IOException {
        try {
            String imageName = getImageForSpecificProduct(UUID.fromString(id));
            return loadFileAsResourceByName(imageName);
        }
    ...
    public BufferedImage loadFileAsResourceByName(String imageName) throws IOException {
        try {
