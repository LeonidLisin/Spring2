...
public class ShopExceptionHandler {
    ...
    @ApiOperation(value = "Возвращает страницу исключения, если продукт не найден по Id")
    ...
    @ApiOperation(value = "Возвращает страницу исключения, если тип изображения не поддерживается")
    ...
    @ApiOperation(value = "Возвращает страницу исключения, если капча введена неверно")
