 ...
 * 2020-04-12T15:16:56.390+03:00
 * Generated source version: 3.2.1
 * 
 */
@WebServiceClient(name = "PaymentPortService", 
                  wsdlLocation = "file:/E:/Java/Spring2/Lesson7/DZ/geekbrains-supershop-lesson_7/src/main/resources/META-INF/wsdl/payment/WsPayment.wsdl",
...
public class PaymentPortService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Java/Spring2/Lesson7/DZ/geekbrains-supershop-lesson_7/src/main/resources/META-INF/wsdl/payment/WsPayment.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(PaymentPortService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/Java/Spring2/Lesson7/DZ/geekbrains-supershop-lesson_7/src/main/resources/META-INF/wsdl/payment/WsPayment.wsdl");
        }
        WSDL_LOCATION = url;
    }
